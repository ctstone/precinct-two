...
@Component({
  ...
  template: `
    ...
    <p2-card title="Meet the Candidates" imageUrl="img/main/istockphoto-1332235868-1024x1024.jpg">
    ...
    <p2-card title="Challenges Ahead" imageUrl="img/main/theater.jpeg" [stagger]="true" [imageWidth]="4">
