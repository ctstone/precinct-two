...
@Component({
  ...
  template: `
    ...
    <p2-card cardTitle="Meet the Candidates" link="candidates" image="img/main/IMG_6742.jpeg">
      <p class="card-text">
      Let&rsquo;s Elect Pro-Housing, Pro-Climate, Pro-People Candidates—<b>Esther</b>, <b>Lauren</b>, <b>Colleen</b>, <b>Elise</b>, and <b>Megan</b>! Together with our endorsement partners, we are dedicated to ensuring everyone in our community—regardless of income, race, background, religion, or age—has access to the resources and opportunities needed to thrive. To make this a reality, we believe Brookline needs strong, inclusive leadership to address the urgent challenges we face. We&rsquo;re the team ready to fight for more affordable housing, support policies to protect our most vulnerable residents, and promote a healthy environment that benefits everyone.
      </p>
      <p class="card-text">
      ...
      <p class="card-text">
        Brookline Town Elections are on <b>Tuesday, May 6th</b>. This is a mission-critical election—Help us get Brookline back on track with education, budgeting, infrastructure, housing, and sustainability!
      </p>
    </p2-card>

    <p2-card cardTitle="The Challenges Ahead" link="challenges-ahead" image="img/main/theater.jpeg" [stagger]="true" [imageWidth]="4">
      <p>The housing issue in Brookline is central to addressing the critical challenges we face. Everything—from the Town Budget to education, transportation, DEAI efforts, and environmental sustainability—are all inextricably linked to our housing needs. According to the Economic Development Advisory Board and the Economic Development and Long-Term Planning division of the Brookline Planning Department, mixed-use development near transit is the best path to increasing the Town&rsquo;s revenue. To thrive as a community, we must prioritize creating more homes of all types. With over 70 percent of Brookline&rsquo;s revenue coming from property taxes, increasing the housing supply will spread the tax base across more properties and relieve financial pressure on current residents.</p>
