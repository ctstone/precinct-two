...
@Component({
  selector: 'p2-issues-economic',
  imports: [],
  template: `
    <h1>Economic Development</h1>

    <p>Our commercial districts are an essential and cherished part of our Brookline community. Residents want these areas to be vibrant hubs, combining retail, restaurant spaces, offices, services, public art, and cultural destinations.

    <p>One of the best ways to support our local businesses is by promoting walkable, multi-family, mixed-income and mixed-use housing, most particularly in our commercial districts and transit corridors.

    <p>Brookline is a fantastic place to live, have a family, and build an amazing network of friends and business partners, but our economic ecosystem has reached its limit. Where we build our homes and how we live in them are critical to strengthening Brookline’s ability to:
