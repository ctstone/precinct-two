...
@Component({
  selector: 'p2-issues-housing',
  imports: [],
  template: `
    <div class="container">
      <h1>Housing</h1>

      <p>Resolving the conflicts between housing density, affordability, sustainability, and preserving Brookline’s historic buildings and neighborhood character is one of our town’s greatest challenges. Housing costs in Brookline are prohibitively high, creating significant barriers to inclusivity. As a result, more families, seniors, teachers, and municipal employees are being pushed out of our community, while Brookline increasingly becomes a community for the ultra-wealthy. The lack of middle-income housing is a key factor in this exclusionary trend, further compounded by zoning restrictions and excessive regulations.</p>
...
export class IssuesHousingComponent {
